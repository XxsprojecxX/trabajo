...
# Contenido completo y correcto para recolector_definitivo.py
contenido_recolector_correcto = """
...
ruta_objetivo = os.path.join("recolector", "recolector_definitivo.py")
try:
    with open(ruta_objetivo, "w") as f:
        f.write(contenido_recolector_correcto.strip())
